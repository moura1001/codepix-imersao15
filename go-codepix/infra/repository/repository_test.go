...
func Test_RepositoriesInsert(t *testing.T) {
	...
	require.Nil(t, err)
	require.NotNil(t, transaction1Db.AccountTo)
	require.Equal(t, transaction1Db.AccountTo.Number, destinationAccount.Number)
	require.NotNil(t, transaction1Db.PixKeyFrom)
	require.NotNil(t, transaction1Db.PixKeyFrom.Account)
	require.NotNil(t, transaction1Db.PixKeyFrom.Account.Bank)
	require.Equal(t, transaction1Db.PixKeyFrom.AccountNumber, sourceAccount.Number)
